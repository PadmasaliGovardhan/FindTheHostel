    ...
    <div className="user-menu-container" ref={ref}>
      ...
      {open && (
        <div className="user-menu-dropdown" id="user-menu-dropdown">
          ...
          <Link href="/profile?tab=reviews" className="user-menu-item" onClick={() => setOpen(false)}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <Link href="/profile?tab=pending" className="user-menu-item" onClick={() => setOpen(false)}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
